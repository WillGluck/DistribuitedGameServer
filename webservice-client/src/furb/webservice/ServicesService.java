 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://webservice.furb/", wsdlLocation = "http://201.54.204.8:8080/services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://webservice.furb/", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://201.54.204.8:8080/services?wsdl");
    ...
    public Services getServicesPort() {
        return super.getPort(new QName("http://webservice.furb/", "ServicesPort"), Services.class);
    }
    ...
    public Services getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.furb/", "ServicesPort"), Services.class, features);
    }
